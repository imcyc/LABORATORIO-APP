...
try{
    ...
    */
    ...
    $calificacion = $uno + $dos + $tres + $cuatro + $cinco + $seis + $siete + $ocho + $nueve + $diez + $once + $doce + $trece + $catorce + $quince + $dieciseis + $diecisiete + $dieciocho + $diecinueve + $veinte + $veintiuno + $veintidos + $veintitres + $veinticuatro;
