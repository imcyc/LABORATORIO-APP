...
$(document).ready(function(){
    ...
    if (elidx !== "") {
        ...
        <div class="resultado">
            <div class="row">
                <div class="col-md-12">
                    <p class="sup" data-porcentaje="43">
        ...
        <div class="row">
            <div class="col-md-12">
                <h4 class="titular">NMX-C-162 MASA UNITARIA</h4>
                <hr>
            </div>
        </div>
            ...
            <div class="row laboratorio">
                <div class="col-md-6">
                    <div class="form-group row">
                        ...
                        <div class="col-10">
                            <input type="hidden" name="certificacion" value="NMX-C-162 MASA UNITARIA">
