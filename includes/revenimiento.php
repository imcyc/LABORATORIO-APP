...
<div class="regresar">
    <button class="btn btn-default azul regresar" data-seq="NMX-C-159 ELABORACIÓN DE CILINDROS" data-ref="cilindros.php" onclick="goBack()"><i class="fa fa-arrow-alt-circle-left"></i> REGRESAR <?php echo $idx; ?></button>
</div>
<div class="resultado">
    <div class="row">
        <div class="col-md-12">
            <p class="sup" data-porcentaje="32">
...
<form id="Rrevenimiento">
    <hr>
    <div class="row laboratorio elidx">
        <div class="jumbotron" style="padding: 20px;border-radius: 0;margin: 15px;">
            <h1 class="display-4" style="font-size:40px;">CERTIFICADO ACI No. <?php echo $idx; ?></h1>
            <p class="lead">Nombre: <?php echo $lastname; ?>, <?php echo $firstname; ?></p>
            <hr>
            <p style="padding-top:10px;">CERTIFICACIÓN: <?php echo $certificacion; ?><br>STATUS: <?php echo $status; ?><br>VÁLIDA HASTA: <?php echo $thru; ?></p>
        </div>
    ...
    <div class="row laboratorio">
        <div class="col-md-6">
            <div class="form-group row">
                ...
                <div class="col-10">
                    <input type="hidden" name="certificacion" value="NMX-C-156 REVENIMIENTO">
    ...
    <?php
    include "../pdc/cnt.php";
    $sql = "SELECT * FROM revenimiento";
    $result = $conn->query($sql);
    if ($result->num_rows > 0) {
        // output data of each row
        while ($row = $result->fetch_assoc()) {
            ?>
            <div class="row cuestionario <?php echo $row["etapa"]; ?>">
