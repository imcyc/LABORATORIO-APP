...
?>
        <div class="regresar">
            <button class="btn btn-default azul regresar" data-seq="NMX-C-159 ELABORACIÓN DE CILINDROS" data-ref="cilindros.php" onclick="goBack()"><i class="fa fa-arrow-alt-circle-left"></i> REGRESAR</button>
        </div>
        <div class="resultado">
        ...
        <form action="Rrevenimiento.php" method="POST">
            <hr>
