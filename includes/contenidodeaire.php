...
$(document).ready(function(){
    ...
    if (elidx !== "") {
        ...
        <div class="row">
            <div class="col-md-12">
                <h4 class="titular">NMX-C-157 CONTENIDO DE AIRE (MÉTODO B)</h4>
                <hr>
            </div>
        </div>
            ...
            <div class="row laboratorio">
                <div class="col-md-6">
                    <div class="form-group row">
                        ...
                        <div class="col-10">
                            <input type="hidden" name="certificacion" value="NMX-C-157 CONTENIDO DE AIRE (METODO B)">
