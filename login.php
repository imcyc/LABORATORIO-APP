...
<style>
html {}
body {background: url(images/bkg.jpg) no-repeat center center fixed; -webkit-background-size: cover;-moz-background-size: cover;-o-background-size: cover;background-size: cover;font-family: 'Raleway', sans-serif;}
...
.footer { display: none;}
    ...
    <div class="container full">
        <div class="container">
            ...
            <form class="formlogin" method="post" id="login-form">
                <div class="row accesos">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <button type="submit" class="btn btn-default" name="btn-login" id="btn-login" style="position:relative;float:right;">
