...
<style>
html {}
body {background: url(images/bkg_aditivos.jpg) no-repeat center center fixed; -webkit-background-size: cover;-moz-background-size: cover;-o-background-size: cover;background-size: cover;font-family: 'Raleway', sans-serif;}
...
.footer { display: none;}
    ...
    <div class="container full">
        <div class="container">
            ...
            <form class="formloginaditivos" method="post" id="login-formaditivos">
                <div class="row accesos">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <button type="submit" class="btn btn-default" name="btn-loginaditivos" id="btn-loginaditivos" style="position:relative;float:right;">
